...
class LocationListAdapter(private val context: LocationListFragment, private val arrayList:List<Location>):ArrayAdapter<Location>(context.requireContext(),R.layout.location_list_item,arrayList) {
