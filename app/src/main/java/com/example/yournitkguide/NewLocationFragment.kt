...
class NewLocationFragment : Fragment() {
    ...
    private fun insertLocationToDatabase(){
        ...
        val location = Location(name=name,description=description, latitude = latitude, longitude = longitude, imgUrl = "https://images.collegedunia.com/public/college_data/images/appImage/15038956701443098931NITSurathkalNew.jpg?mode=stretch",id=0)
        print("HII")
